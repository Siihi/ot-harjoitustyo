...
class RemoveUserView:
    ...
    def remove_user_handler(self):
        ...
        try:
            ...
            self.show_error("Käyttäjätunnusta ei löydy")
    ...
    def initialize(self):
        ...
        heading_label = ttk.Label(master=self.frame, text="Poista käyttäjä")
        ...
        remove_user_button = ttk.Button(master=self.frame, text="Poista käyttäjä", command=self.remove_user_handler)
        ...
        remove_user_button.grid(row=4, column=0, sticky=constants.W, padx=4, pady=4)
