...
class TestMaksukortti(unittest.TestCase):
    ...
    def kortilla_pystyy_ostamaan_edullisen_lounaan_kun_rahaa_vain_sen_verran(self):
        self.kortti = Maksukortti(2.5)
        self.kortti.syo_edullisesti()
        self.assertEqual(str(self.kortti), "Kortilla on rahaa 0 euroa")

    def kortilla_pystyy_ostamaan_maukkaan_lounaan_kun_rahaa_vain_sen_verran(self):
